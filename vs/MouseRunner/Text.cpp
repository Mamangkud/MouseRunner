...
void Demo::RenderText(string text, GLfloat x, GLfloat y, GLfloat scale, vec3 color)
{
	...
	glUniform3f(glGetUniformLocation(this->programG, "ourColor"), color.x, color.y, color.z);
	glUniform1i(glGetUniformLocation(this->programG, "text"), 1);
	glActiveTexture(GL_TEXTURE0);
	glUniform1i(glGetUniformLocation(this->programG, "ourTexture"), 0);
	mat4 model;
